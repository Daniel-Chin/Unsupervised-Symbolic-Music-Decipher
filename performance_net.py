'''
Based on 
https://github.com/bwang514/PerformanceNet/blob/master/src/model.py
of
Wang, B., & Yang, Y. H. (2019, July). PerformanceNet: Score-to-audio music generation with multi-band convolutional residual network. In Proceedings of the AAAI Conference on Artificial Intelligence (Vol. 33, No. 01, pp. 1174-1181).
'''
...
class PerformanceNet(nn.Module):
    def __init__(self, depth = 5, start_channels = 128, end_channels = 1025):
    ...
    def construct_layers(self):
        ...
        self.lastconv = nn.ConvTranspose1d(1024,self.end_channels,kernel_size=3, stride=1, padding=1)
        self.lrelu = nn.LeakyReLU(0.01)
        self.onset_offset_encoder = Onset_Offset_Encoder(start_channels=self.start_channels)
