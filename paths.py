...
TRANSFORMER_PIANO_MONKEY_DATASET_DIR = path.join(DATA_DIR, 'transformer_piano_monkey_dataset')
os.makedirs(TRANSFORMER_PIANO_MONKEY_DATASET_DIR, exist_ok=True)
TRANSFORMER_PIANO_ORACLE_DATASET_DIR = path.join(DATA_DIR, 'transformer_piano_oracle_dataset')
