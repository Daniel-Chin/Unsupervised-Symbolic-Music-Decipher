...
CNN_PIANO_MONKEY_DATASET_DIR = path.join(DATA_DIR, 'cnn_piano_monkey_dataset')
os.makedirs(CNN_PIANO_MONKEY_DATASET_DIR, exist_ok=True)
CNN_PIANO_ORACLE_DATASET_DIR = path.join(DATA_DIR, 'cnn_piano_oracle_dataset')
os.makedirs(CNN_PIANO_ORACLE_DATASET_DIR, exist_ok=True)
